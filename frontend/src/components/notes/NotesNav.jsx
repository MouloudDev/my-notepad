...
const EllipsisHorizontal = forwardRef((_, ref) => (
  <svg ref={ref} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-9 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600">
