...
export default function Settings() {
  ...
  return (
    <div className="ml-auto w-full max-w-56">
      ...
      >
        <span className="text-xl font-semibold truncate">{user.email}</span>
        <Cog6 />
      </button>
      <div className={`${showOptions ? "h-[265px] transition-all duration-1000" : "h-0"} truncate mt-1`}>
        <button
          onClick={() => dispatch(zoomIn())}
          className="group flex justify-between my-1 p-2 rounded-lg gap-2 w-full border border-gray-500 hover:bg-gray-500 transition-all duration-300"
        >
        ...
        <div className="my-1">
          <h2 className="text-lg font-bold">Text style</h2>
          <button
            onClick={() => dispatch(setFont(""))}
            className="flex justify-between my-1 p-2 gap-2 w-full rounded-lg border border-gray-500 hover:bg-gray-500 transition-all duration-300"
          >
          ...
          <button
            ...
            className="flex justify-between my-1 p-2 gap-2 w-full rounded-lg border border-gray-500 hover:bg-gray-500 transition-all duration-300"
          >
            <span className="font-normal">Handwriting</span>
          ...
          <button
            ...
            className="flex justify-between my-1 p-2 gap-2 w-full rounded-lg border border-gray-500 hover:bg-gray-500 transition-all duration-300"
          >
            <span className="font-normal">Geist Mono</span>
...
function DateTime() {
  ...
  return (
    <div className="flex items-center my-1 p-2 gap-2 w-full rounded-lg border border-gray-500 transition-all duration-300">
      <Clock />
      <span className="text-lg text-gray-300">{month} {day} | {formattedHours}:{minutes.toString().padStart(2, "0")} {amPm}</span>
    </div>
  );
}
...
function Cog6() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 transition-transform duration-0 group-hover:rotate-[360deg] group-hover:duration-1000">
...
function MagnifierPlus() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-gray-300 group-hover:text-white">
